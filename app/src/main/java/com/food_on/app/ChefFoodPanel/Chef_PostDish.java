...
//
//                            if (isValid()) {
//                                Toast.makeText(Chef_PostDish.this, "before uri: "+imageuri, Toast.LENGTH_LONG).show();
//                                uploadImage();
//                                Toast.makeText(Chef_PostDish.this, "after", Toast.LENGTH_LONG).show();
//                            }
//                        }
//                    });
//                }
...
//
//        Toast.makeText(Chef_PostDish.this, "uri: "+imageuri, Toast.LENGTH_LONG).show();
//
//        if (imageuri != null) {
...
public class Chef_PostDish extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
